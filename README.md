...
* [Dsheiko\Validate](https://github.com/dsheiko/validate) - Validation library for testing primitive and complex types (including key-value arrays) against a contract.
